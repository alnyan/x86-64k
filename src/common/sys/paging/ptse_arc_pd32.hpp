...
protected:
    ...
    page_table_entry32_t m_tables[PTSE_ENTRIES32] = {};
...
protected:
    unsigned m_mappedEntries = 0;
    page_directory_entry32_t m_tables[PTSE_ENTRIES32] = {};
    ...
    bool vaddrBelowLimit(uint32_t vaddr) override { return true; } // 32-bit address is always below limit
